...
public class C06_Verification {
    ...
    // 1. method : createMethod(100)
    // deleteButtonAndValidate()
    ...
    private static void deleteButtonsAndValidate(WebDriver driver, int number) {
        List<WebElement> elements = driver.findElements(By.cssSelector("[oclick='deleteElement()']"));
        int sizeBeforeDelete=elements.size();

        List<WebElement> buttonsDelete =driver.findElements(By.cssSelector("[oclick='deleteElement()']"));
        int sayac=0;
        ...
        List<WebElement> elementsAfter= driver.findElements(By.cssSelector("[oclick='deleteElement()']"));
